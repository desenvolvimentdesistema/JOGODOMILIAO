...
public abstract class IAjuda
{
    ...
    protected Button ButtonResposta5;
        ...
        public void ConfiguraDesenhar(Button ButtonResposta1, Button ButtonResposta2, Button ButtonResposta3, Button ButtonResposta4, Button ButtonResposta5)
        {
        ...
        public void ConfiguraDesenhar(Frame frameAjuda)
        {
